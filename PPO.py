...
def main():
    ...
    solved_reward = 0.1 # stop training if avg_reward > solved_reward
    ...
    nn_model = NN(5, 1)
    nn_model.load_weights('./policies/' + args.scenario.lower() + '_all_CoIL')
    ...
    for i_episode in range(1, max_episodes + 1):
        ...
        for t in range(max_timesteps):
            ...
            action_real = nn_model.call(state, mode).numpy().reshape(-1)

            state, reward, done, _ = env.step(action_real)

            # print("mode: ", mode)
            # print("action_real: ", action_real )
        ...
        if running_reward > (log_interval * solved_reward):
            ...
            torch.save(ppo.policy.state_dict(), './checkpoints/rl_checkpoint_' + args.case.lower())
